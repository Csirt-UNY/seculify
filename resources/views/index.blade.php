    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-7 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1"
                ...
                <h1>Seculify: Security Education Improvement Qualify</h1>
                <h2>Seculify berperan dalam memastikan bahwa pembelajaran yang disediakan sesuai dengan standar terbaik,
                    sehingga membantu dalam mengurangi risiko keamanan yang mungkin timbul.</h2>
            ...
            <div class="col-lg-5 order-1 order-lg-2 hero-img ms-6 d-flex justify-content-center" data-aos="zoom-in"
                data-aos-delay="200">
                <img src="assets/img/seculify/logo_shine.png" class="img-fluid animated" alt="UNY Csirt">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="container" data-aos="zoom-in">
            <div class="row">
                <div class="col-lg-9 text-center text-lg-start">
                    ...
                    <p>Silakan klik tombol 'Login' untuk melanjutkan test performa Anda masing-masing.</p>
                </div>
                <div class="col-lg-3 cta-btn-container text-center">
                    <a class="cta-btn align-middle" href="{{ route('login') }}">Login untuk memulai</a>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-12 d-flex align-items-stretch">
                    <div class="info">
                        <div class="qris">
                            ...
                            <h3>QRIS:</h3>
                            <img style="max-width: 250px; margin-top: 12px;" src="{{asset('storage/configs/'.$qr_donasi->value)}}" alt="qr_donasi" class="img-fluid">
                            {{-- <p></p> --}}
                        </div>
