                ...
                <div class="card-body">
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            @include('admin.questions.modals.delete-modal')
                            @include('admin.questions.modals.edit-modal')
                            @include('admin.questions.modals.show_question-modal')
                            @endforeach
                        </tbody>
                    </table>
                </div>
...
@include('admin.questions.modals.create-modal')
@endsection
...
<script>
    function navigateToQuests(select) {
        ...
        if (testId) {
            window.location.href = '/admin/' + testId + '/quests';
        }
    }
</script>
