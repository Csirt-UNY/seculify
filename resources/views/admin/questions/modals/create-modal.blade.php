<div class="modal fade" id="tambahModal" tabindex="-1" role="dialog" aria-labelledby="tambahModalTitle"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('admin.quests.store', ['test' => $test])}}" method="post"
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                            id="exampleInputTitle1" placeholder="Masukkan judul pertanyaan" autocomplete="title" required
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="summern form-control @error('question_content') is-invalid @enderror" name="question_content" required
                            id="summernote">{{ old('question_content') }}</textarea>
